...
def initialize_database(app, db):
    ...
    with app.app_context():
        db.drop_all()
        db.create_all()
        first_ad = Advertisement('Discount Clothing', '/t/clothing', 1, '1.jpg')
        second_ad = Advertisement('Cool Hats', '/products/datadog-ringer-t-shirt', 1, '2.jpg')
        third_ad = Advertisement('Nice Bags', '/t/bags', 1, '3.jpg')
